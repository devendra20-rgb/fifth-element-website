export default function PrivacyCenter() {
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <p className="text-lg text-gray-700 mb-4">
        You can also manage your privacy settings, including opting out of certain data collection practices and controlling how your information is shared with third parties. We are committed to giving you control over your data and ensuring that your privacy preferences are respected.
        </p>
        <p className="text-lg text-gray-700">
        If you have any questions or concerns about our privacy practices, please don't hesitate to contact us. We are here to help and are committed to providing you with the information and support you need to make informed decisions about your privacy.
        </p>
    </div>
  );
}